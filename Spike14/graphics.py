...
This module creates a simple object.py named "egi", which is an instance of the
...
class EasyGraphics(object):
    ...
    def InitWithPyglet(self, window):
        ...
        self.window = window
        # prep the text object.py
        self.text = font.Text(font.load('', 10), '', color=(1, 1, 1, 1),
                              valign='bottom', halign='left')
        # prep the quadric object.py used by glu* functions (circle)
